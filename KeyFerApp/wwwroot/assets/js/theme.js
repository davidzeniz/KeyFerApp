...
var linePaymentChartInit = function linePaymentChartInit() {
  ...
  var dataset = {
    ...
    successful: [2, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5, 2],
    failed: [4, 0, 2, 1, 2, 1, 1, 0, 0, 1, 0, 2]
  };
  var labels = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Setiembre', 'Octubre', 'Noviembre', 'Diciembre'];
